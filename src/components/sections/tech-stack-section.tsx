...
import {SiBootstrap, SiCss3, SiHtml5, SiJavascript, SiTypescript, SiJquery, SiPhp, SiReact, SiSass, SiTailwindcss, SiWordpress, SiLaravel, SiNodedotjs} from 'react-icons/si';
