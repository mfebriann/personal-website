...
const EXPERIENCES = [
  {
    ...
    highlights: [
      ...
      "Make games with Unreal Engine 5",
      "Make mobile application with React Native",
    ],
  },
  {
    ...
    highlights: [
      ...
      "Create a display for a medical buying and selling website WordPress, and custom HTML, CSS and JavaScript",
    ],
  },
  {
      ...
      <div className="mx-auto flex max-w-6xl flex-col gap-10 px-6">
        <div className="space-y-4 text-center md:text-left">
          ...
          <p className="text-base text-slate-600 md:max-w-2xl">
            A snapshot of hands-on roles where I delivered web, mobile, and product experiences end-to-end.
          </p>
        </div>

        <div className="relative">
          <div
            className="absolute left-[23px] top-4 bottom-4 hidden w-px bg-gradient-to-b from-transparent via-slate-200 to-transparent md:block"
            aria-hidden
          />
